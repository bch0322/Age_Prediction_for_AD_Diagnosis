...
input_size = 170
list_conv_kernel = [3, 3, 3, 1, 1,] # kernel size of the layers
list_conv_stride = [1, 2, 2, 1, 1,] # stride size of the layers
# list_conv_kernel = [3, 3, 3] # kernel size of the layers
# list_conv_stride = [2, 2, 1] # stride size of the layers
